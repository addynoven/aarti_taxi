export function ContactHeroImage() {
  return (
    <div className="relative rounded-[2rem] overflow-hidden shadow-xl group h-[450px]">
      <img src="https://images.unsplash.com/photo-1549317661-bd32c8ce0db2?auto=format&fit=crop&q=80" alt="Pristine Taxi Fleet" className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
