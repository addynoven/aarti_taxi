...
export function IntercityFleet() {
  const cars = [
    {
      id: "sedan",
  ...
  return (
    <div className="bg-[#EFEFEF] py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-12">
          <h2 className="text-3xl font-extrabold text-[#1A1A1A] tracking-tight mb-2">
            Our Curated <span className="text-[#CA8A04]">Fleet</span>
          </h2>
          <p className="text-slate-500 font-medium text-sm">Choose the perfect companion for your journey.</p>
        </div>
