    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-24">
      <div className="bg-[#FACC15] rounded-[2.5rem] p-12 lg:p-20 text-center shadow-md">
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
          <a href="tel:+917838747009" onClick={reportConversion} className="inline-flex items-center justify-center bg-[#1A1A1A] text-white font-bold px-8 py-3.5 rounded-full hover:bg-black transition-colors shadow-sm text-sm group">
